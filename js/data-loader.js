...
(function () {
    ...
    function notice(message) {
        ...
        if (!node) {
            ...
            node.style.cssText = "padding:12px 16px;margin:16px 0;max-width:900px;background:#fff4d6;color:#513d08;border-radius:6px";
            const intro = document.querySelector(".inner-page-intro");
            if (intro) intro.insertAdjacentElement("afterend", node);
            else document.querySelector(".main-content .container").append(node);
        }
